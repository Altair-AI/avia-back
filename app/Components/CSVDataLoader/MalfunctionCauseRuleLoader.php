...
class MalfunctionCauseRuleLoader
{
    ...
    /**
     * Add new malfunction cause rules to database.
     *
     * @param array $operation_codes - added operation codes
     ...
     * @return array
     */
    public function addMalfunctionCauseRule(array $operation_codes, array $row,
                                            int $knowledge_base_id, bool $encoding = false)
    {
     ...
     * @param bool $encoding - flag to include or exclude encoding conversion from windows-1251 to utf-8
     */
    public function createMalfunctionCauseRules(int $knowledge_base_id, bool $encoding = false)
    {
        $operation_codes = [];
        ...
        while (($row = fgetcsv($fh, 0, ';')) !== false)
            $operation_codes = self::addMalfunctionCauseRule($operation_codes, $row, $knowledge_base_id, $encoding);
    }
}
