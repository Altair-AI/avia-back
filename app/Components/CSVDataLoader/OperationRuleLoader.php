...
class OperationRuleLoader
{
     ...
     */
    public function getOperationResultId(string $operation_result_name)
    {
    ...
    /**
     * Add new operation rule to database.
     *
     ...
     */
    public function addOperationRule(array $row, int $knowledge_base_id, bool $encoding = false)
    {
        ...
        if ($operation_if and $operation_then) {
            ...
            $operation_result_id_if = self::getOperationResultId($operation_result_name_if);
            $operation_result_id_then = self::getOperationResultId($operation_result_name_then);
     ...
     * @param bool $encoding - flag to include or exclude encoding conversion from windows-1251 to utf-8
     */
    public function createOperationRules(int $knowledge_base_id, bool $encoding = false)
    {
