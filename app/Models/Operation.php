...
class Operation extends Model
{
    ...
    /**
     * Получить все коды (признаки) неисправностей соответствующие данной работой (операцией).
     */
    ...
    /**
     * Получить все причины неисправностей связанные с данной работой (операцией).
     */
